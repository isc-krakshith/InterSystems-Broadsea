...
```
docker compose pull && docker-compose --profile default --build up -d
```
OR the longer version
```
docker-compose pull && docker-compose --profile atlas-from-image --profile webapi-local --profile atlasdb --profile content --build up -d
```
