CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_censor_stats (cohort_definition_id int NOT NULL,
  lost_count BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_inclusion (cohort_definition_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_inclusion_result (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_inclusion_stats (cohort_definition_id int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_summary_stats (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_cache  (design_hash int NOT NULL,
	SUBJECT_ID bigint NOT NULL,
	cohort_start_date date NOT NULL,
	cohort_end_date date NOT NULL
);

CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_censor_stats_cache  (design_hash int NOT NULL,
  lost_count BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_inclusion_result_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_inclusion_stats_cache  (design_hash int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
  gain_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_summary_stats_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.feas_study_inclusion_stats (study_id int NOT NULL,
  rule_sequence int NOT NULL,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.feas_study_index_stats (study_id int NOT NULL,
  person_count bigint NOT NULL,
  match_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.feas_study_result (study_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.heracles_analysis
 (analysis_id int,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.HERACLES_HEEL_results 
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.heracles_results
 (cohort_definition_id int,
	analysis_id int,
...
--HINT PARTITION(cohort_definition_id int)
 -- haven't looked into this yet
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.heracles_results_dist
 (cohort_definition_id int,
	analysis_id int,
	stratum_1 varchar(255),
	stratum_2 varchar(255),
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.heracles_periods
 (period_id int,
  period_order int,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cohort_sample_element (cohort_sample_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.ir_analysis_dist  (analysis_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.ir_analysis_result (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.ir_analysis_strata_stats (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.ir_strata (analysis_id int NOT NULL,
  strata_sequence int NOT NULL,
  name varchar(255) NULL,
  description varchar(1000) NULL
);

CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.cc_results
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.pathway_analysis_codes
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.pathway_analysis_events
 (pathway_analysis_generation_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.pathway_analysis_paths
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
  step_1 BIGINT,
  step_2 BIGINT,
...
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.pathway_analysis_stats
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
...
/*********************************************************************/
CREATE TABLE IF NOT EXISTS OMOPCDM54_RESULTS.concept_hierarchy
 (concept_id             INT,
...
/***********************************************************/
TRUNCATE TABLE OMOPCDM54_RESULTS.concept_hierarchy;

/********** CONDITION/CONDITION_ERA **********/
INSERT INTO OMOPCDM54_RESULTS.concept_hierarchy
...
LEFT JOIN (
	...
	FROM OMOPCDM54.concept c1
	INNER JOIN OMOPCDM54.concept_ancestor ca1 ON c1.concept_id = ca1.descendant_concept_id
		AND c1.domain_id = 'Condition'
		AND ca1.min_levels_of_separation = 1
	INNER JOIN OMOPCDM54.concept c2 ON ca1.ancestor_concept_id = c2.concept_id
...
LEFT JOIN OMOPCDM54.concept soc ON hlgt_to_soc.soc_concept_id = soc.concept_id;
...
LEFT JOIN OMOPCDM54.concept atc1 ON atc3_to_atc1.atc1_concept_id = atc1.concept_id;
...
FROM (
	SELECT DISTINCT
		concept_id,
		concept_name
	FROM OMOPCDM54.concept c
	WHERE domain_id = 'Measurement'
) m
LEFT JOIN OMOPCDM54.concept_ancestor ca1 ON M.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN OMOPCDM54.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN OMOPCDM54.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN OMOPCDM54.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN OMOPCDM54.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
LEFT JOIN OMOPCDM54.concept c3 ON ca3.ANCESTOR_CONCEPT_ID = c3.concept_id
...
LEFT JOIN OMOPCDM54.concept_ancestor ca1 ON obs.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN OMOPCDM54.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN OMOPCDM54.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN OMOPCDM54.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN OMOPCDM54.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
...
(
	...
	FROM OMOPCDM54.concept c1
	INNER JOIN OMOPCDM54.vocabulary v1 ON c1.vocabulary_id = v1.vocabulary_id
...
LEFT JOIN (
	...
	FROM OMOPCDM54.concept_ancestor ca0
	INNER JOIN (
		SELECT DISTINCT c2.concept_id AS os3_concept_id
		FROM OMOPCDM54.concept_ancestor ca1
		INNER JOIN OMOPCDM54.concept c1 ON ca1.DESCENDANT_CONCEPT_ID = c1.concept_id
		INNER JOIN OMOPCDM54.concept_ancestor ca2 ON c1.concept_id = ca2.ANCESTOR_CONCEPT_ID
		INNER JOIN OMOPCDM54.concept c2 ON ca2.DESCENDANT_CONCEPT_ID = c2.concept_id
...
TRUNCATE TABLE OMOPCDM54_RESULTS.heracles_analysis;

insert into OMOPCDM54_RESULTS.heracles_analysis
...
CREATE GLOBAL TEMPORARY TABLE OMOP_TEMP.mi7vgri9digits
 AS SELECT digits.n   FROM (
       select 0 as n union all select 1 union all select 2 union all select 3 union all select 4 union all select 5 union all select 6 union all select 7 union all select 8 union all select 9
) digits;

CREATE GLOBAL TEMPORARY TABLE OMOP_TEMP.mi7vgri9generate_dates
 AS SELECT y1.n + (10*y10.n) + (100*y100.n) + (1000*y1000.n) AS d_years,
	mths.n as d_months
 FROM OMOP_TEMP.mi7vgri9digits y1,
OMOP_TEMP.mi7vgri9digits y10,
...
CREATE GLOBAL TEMPORARY TABLE OMOP_TEMP.mi7vgri9yearly_dates
 AS SELECT TO_DATE(TO_CHAR(d_years,'FM0000')||'-'||TO_CHAR(d_months,'FM00')||'-'||TO_CHAR(01,'FM00'), 'YYYY-MM-DD') as generated_date
 FROM OMOP_TEMP.mi7vgri9generate_dates
where d_months = 1
;

CREATE GLOBAL TEMPORARY TABLE OMOP_TEMP.mi7vgri9monthly_dates
 AS SELECT TO_DATE(TO_CHAR(d_years,'FM0000')||'-'||TO_CHAR(d_months,'FM00')||'-'||TO_CHAR(01,'FM00'), 'YYYY-MM-DD') as generated_date
 FROM OMOP_TEMP.mi7vgri9generate_dates
;

CREATE GLOBAL TEMPORARY TABLE OMOP_TEMP.mi7vgri9weekly_dates
 ...
 FROM (
	...
	from OMOP_TEMP.mi7vgri9digits d1, OMOP_TEMP.mi7vgri9digits d10, OMOP_TEMP.mi7vgri9digits d100, OMOP_TEMP.mi7vgri9digits d1000
) seq;

CREATE GLOBAL TEMPORARY TABLE OMOP_TEMP.mi7vgri9quarterly_dates
...
-- monthly dates
CREATE GLOBAL TEMPORARY TABLE OMOP_TEMP.mi7vgri9temp_period
 AS SELECT *
 FROM (
...
from OMOP_TEMP.mi7vgri9monthly_dates md
UNION ALL
...
from OMOP_TEMP.mi7vgri9weekly_dates wd
...
from OMOP_TEMP.mi7vgri9quarterly_dates qd
UNION ALL
...
from OMOP_TEMP.mi7vgri9yearly_dates yd
-- ADD UNION ALLs for additional period definitions
) monthlyDates;

TRUNCATE TABLE OMOPCDM54_RESULTS.heracles_periods;
...
from OMOP_TEMP.mi7vgri9temp_period;

truncate table OMOP_TEMP.mi7vgri9digits;

drop table OMOP_TEMP.mi7vgri9digits;

truncate table OMOP_TEMP.mi7vgri9generate_dates;

drop table OMOP_TEMP.mi7vgri9generate_dates;

truncate table OMOP_TEMP.mi7vgri9yearly_dates;

drop table OMOP_TEMP.mi7vgri9yearly_dates;

truncate table OMOP_TEMP.mi7vgri9quarterly_dates;

drop table OMOP_TEMP.mi7vgri9quarterly_dates;

truncate table OMOP_TEMP.mi7vgri9monthly_dates;

drop table OMOP_TEMP.mi7vgri9monthly_dates;

truncate table OMOP_TEMP.mi7vgri9weekly_dates;

drop table OMOP_TEMP.mi7vgri9weekly_dates;

TRUNCATE TABLE OMOP_TEMP.mi7vgri9temp_period;

DROP TABLE OMOP_TEMP.mi7vgri9temp_period;

CREATE INDEX HRD_IDX_COHORT_DEF_ID ON OMOPCDM54_RESULTS.HERACLES_RESULTS_DIST (cohort_definition_id);

CREATE INDEX HRD_IDX_COHORT_ID_ANALYSIS_ID ON OMOPCDM54_RESULTS.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id);

CREATE INDEX HRD_IDX_COHORT_DEF_ID_DT ON OMOPCDM54_RESULTS.HERACLES_RESULTS_DIST (cohort_definition_id, last_update_time);

CREATE INDEX HRD_IDX_COHORT_ID_FIRST_RES ON OMOPCDM54_RESULTS.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX HR_IDX_COHORT_DEF_ID ON OMOPCDM54_RESULTS.HERACLES_RESULTS (cohort_definition_id);

CREATE INDEX HR_IDX_COHORT_ID_ANALYSIS_ID ON OMOPCDM54_RESULTS.HERACLES_RESULTS (cohort_definition_id, analysis_id);

CREATE INDEX HR_IDX_COHORT_ANALYSIS_CONCEPT  ON OMOPCDM54_RESULTS.HERACLES_RESULTS  (cohort_definition_id, analysis_id);

CREATE INDEX HR_IDX_COHORT_DEF_ID_DT ON OMOPCDM54_RESULTS.HERACLES_RESULTS (cohort_definition_id, last_update_time);

CREATE INDEX HR_IDX_COHORT_ID_FIRST_RES ON OMOPCDM54_RESULTS.HERACLES_RESULTS (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX HH_IDX_COHORT_ID_ANALYSIS_ID ON OMOPCDM54_RESULTS.HERACLES_HEEL_RESULTS (cohort_definition_id, analysis_id);

CREATE INDEX idx_heracles_periods_startdate ON OMOPCDM54_RESULTS.heracles_periods (period_start_date);

CREATE INDEX idx_heracles_periods_end_date ON OMOPCDM54_RESULTS.heracles_periods (period_end_date);

CREATE INDEX idx_cohort_sample_element_rank ON OMOPCDM54_RESULTS.cohort_sample_element (cohort_sample_id, rank_value);

CREATE INDEX idx_pathway_events_combo_id ON OMOPCDM54_RESULTS.pathway_analysis_events (combo_id);